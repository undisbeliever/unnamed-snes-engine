...
from .json_formats import Name, Callback, Mappings
...
ROOM_CALLBACK: Final = CallbackType("room event", "room.roomEventParameters", 4)
...
def write_callback_parameters_wiz(out: StringIO, callbacks: OrderedDict[Name, Callback], callback_type: CallbackType) -> None:
