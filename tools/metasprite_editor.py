...
from _json_formats import load_ms_export_order_json, load_metasprite_frameset_from_dict, \
                          Name, Filename, MsExportOrder, MsSpritesheet, MsFrameset
...
class AnimationEditor:
    ...
    def __init__(self, fs_editor : 'FramesetEditor', parent : tk.Frame):
        ...
        self.use_fixed_delay_cb : Final = tk.Checkbutton(parent, text='Fixed Frame Delay', variable=self.use_fixed_delay_value, command=self._on_use_fixed_delay_clicked)
...
class FramesetEditor:
    ...
    def __init__(self, editor_window : 'EditorWindow', parent : ttk.Notebook):
        ...
        self.add_missing_animations_button : Final = tk.Button(self.frame, text='Add Missing Animations', command=self.add_missing_animations)
