...
def compile_list(
    typename: Name, mapping: list[Name], inputs: dict[str, Any], func: Callable[[Any], bytes]
) -> Optional[list[ResourceEntry]]:
    valid = True
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("other_resources_json_file", action="store", help="other resources JSON file input")
